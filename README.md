...
Notice: пока существует проблема с сервисом Amazon S3. На страницах могут отсутствовать
изображения и не работать загрузка приложений к задачам (Heroku плохо работает со статикой и медиафайлами)
