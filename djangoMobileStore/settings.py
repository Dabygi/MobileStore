...
if USE_S3:
    ...
    AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BUCKET_NAME}.s3.{AWS_S3_REGION_NAME}.amazonaws.com'     #f's3.{AWS_S3_REGION_NAME}.s3.amazonaws.com'   https://mobile-my-store.s3.us-east-1.amazonaws.com/media/
